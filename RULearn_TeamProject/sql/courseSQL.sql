/*
 * course 관련 table 및 data
 * 작성자: 최다연
 */

--table LESSON에 column 추가
ALTER TABLE LESSON ADD L_THUMBNAIL VARCHAR2(200);
ALTER TABLE LESSON ADD L_LESSON_CATEGORY VARCHAR2(50);

--table LESSON에 data 추가
UPDATE LESSON SET L_TITLE = '애니메이션과 이모티콘 만드는 진짜 애니메이트 클래스' WHERE L_ID = 1;
UPDATE LESSON SET L_CONTENT = '입문자를 위해 준비한 [그래픽 디자인, 디자인 툴] 강의입니다.
...
WHERE L_ID = 1;
UPDATE LESSON SET L_THUMBNAIL = 'https://cdn.inflearn.com/public/course-325346-cover/b433bf9a-bffa-41cb-b325-e38aaffd228d' WHERE L_ID = 1;
UPDATE LESSON SET L_LESSON_CATEGORY = '기타' WHERE L_ID = 1;
UPDATE LESSON SET L_PRICE = 49500 WHERE L_ID = 1;
...
CREATE TABLE CURRICULUM_BIG(
	...
	CUR_BIG_CURID			NUMBER,	--강의 제목의 번호
...
INSERT INTO CURRICULUM_SMALL VALUES(1, 1, '애니메이트는 어떤 프로그램인가?', 'VIDEO', '04:55');
INSERT INTO CURRICULUM_SMALL VALUES(1, 2, '애니메이트 기본 화면 및 기본 도구 살펴보기', 'VIDEO', '10:45');
INSERT INTO CURRICULUM_SMALL VALUES(1, 2, '환경 설정과 단축키 세팅하기', 'VIDEO', '04:47');
INSERT INTO CURRICULUM_SMALL VALUES(1, 3, '이모티콘을 위한 캐릭터를 구상하는 법', 'VIDEO', '05:32');
INSERT INTO CURRICULUM_SMALL VALUES(1, 3, '애니메이트의 기본 드로잉 방법', 'VIDEO', '07:09');
INSERT INTO CURRICULUM_SMALL VALUES(1, 3, '애니메이트의 캐릭터 드로잉 방법', 'VIDEO', '15:01');
INSERT INTO CURRICULUM_SMALL VALUES(1, 3, '애니메이션 작업 전 캐릭터 세팅하는 법', 'VIDEO', '05:38');
INSERT INTO CURRICULUM_SMALL VALUES(1, 4, '타임 라인', 'VIDEO', '05:54');
INSERT INTO CURRICULUM_SMALL VALUES(1, 4, '심볼', 'VIDEO', '10:24');
INSERT INTO CURRICULUM_SMALL VALUES(1, 4, '트위닝', 'VIDEO', '19:55');

INSERT INTO CURRICULUM_SMALL VALUES(2, 1, '강의 소개', 'VIDEO', '07:17');
INSERT INTO CURRICULUM_SMALL VALUES(2, 1, '강의 커리큘럼 및 실습 코드 소개', 'VIDEO', '06:06');
INSERT INTO CURRICULUM_SMALL VALUES(2, 1, '강의 교재 및 실스 코드 다운로드', 'DOCUMENT', NULL);
INSERT INTO CURRICULUM_SMALL VALUES(2, 2, '카프카, 시작하며', 'VIDEO', '02:58');
INSERT INTO CURRICULUM_SMALL VALUES(2, 2, 'Topic과 Partition 그리고 카프카 병렬 분산 처리 개요', 'VIDEO', '15:51');
INSERT INTO CURRICULUM_SMALL VALUES(2, 2, 'kafka-topics 명령어를 이용하여 Topic 생성 및 정보 확인하기', 'VIDEO', '12:10');
INSERT INTO CURRICULUM_SMALL VALUES(2, 3, 'Java기반의 카프카 클라이언트 구현 실습을 시작하며', 'VIDEO', '02:38');
INSERT INTO CURRICULUM_SMALL VALUES(2, 3, 'Java 기반 카프카 클라이언트(Client) 구현 실습을 위한 JDK및 Intellij 설치', 'VIDEO', '09:06');
INSERT INTO CURRICULUM_SMALL VALUES(2, 3, 'Java 기반 카프카 클라이언트 구현을 위한 Intellij 프로젝트 설정 및 멀티 Module 설정하기', 'VIDEO', '06:15');

INSERT INTO CURRICULUM_SMALL VALUES(3, 1, 'OT', 'VIDEO', '06:04');
INSERT INTO CURRICULUM_SMALL VALUES(3, 1, '프로젝트 다운로드', 'VIDEO', '03:17');
INSERT INTO CURRICULUM_SMALL VALUES(3, 1, '환경 설정', 'DOCUMENT', '22:20');
INSERT INTO CURRICULUM_SMALL VALUES(3, 2, 'Sprite vs UI', 'VIDEO', '20:58');
INSERT INTO CURRICULUM_SMALL VALUES(3, 2, '프리팹 제작 및 실전 팁', 'VIDEO', '31:46');
INSERT INTO CURRICULUM_SMALL VALUES(3, 3, '게임 컨텐츠 제작 및 설계', 'VIDEO', '25:10');
INSERT INTO CURRICULUM_SMALL VALUES(3, 4, '광고와 인앱 결제', 'VIDEO', '16:19');

--table REVIEW_BOARD에 data 추가
INSERT INTO REVIEW_BOARD
VALUES(REVIEW_BOARD_SEQ.NEXTVAL, 'best1234', 1, '다시 한번 봐야겠어요.', 2, SYSDATE);
INSERT INTO REVIEW_BOARD
VALUES(REVIEW_BOARD_SEQ.NEXTVAL, 'best1234', 1, 
		'한 마디로 말하자면, 다음 편이 기대되는 강의입니다!
		
		처음에는 애니메이트라는 생소한 툴과 사용방법 때문에 손이 가질 않더라고요. 하지만 선생님이 말씀하신대로 처음부터 완벽히 이해하려 하지 않고, 천천히 반복적으로 해 봤습니다. 그랬더니 중후반부에는 단축키를 척척 누르면서 작업을 해 나가는 제가 있었습니다! 얼마나 뿌듯하던지 ^-^b
		
		또한 수강을 하며 선생님께서 수업에 필요한 부분들을 다양하게, 또 깊게 알고 계신다는 느낌을 받았습니다. 모르는 부분이 있으면 언제든 말해달라 하셔서 정말 시도때도 없이 질문하고 메일을 드렸는데 굉장히 빠르고 정확하게 알려주시더라고요. 미안하면서도 감사했네요 ㅎㅎ 덕분에 궁금증이 그때그때 풀렸고, 다음 수업을 진행하는 데도 무리가 없었습니다.',
		5, SYSDATE);
INSERT INTO REVIEW_BOARD
VALUES(REVIEW_BOARD_SEQ.NEXTVAL, 'best1234', 1, 
		'클래스101에서도 들어보고 인플런에서도 들어봤는데요
		그리네모 작가님의 수업은 좀 더 입문자++ 정도 수준인 것 같아 좋습니다!
		많이 배우고 있습니다.',
		5, SYSDATE);
INSERT INTO REVIEW_BOARD
VALUES(REVIEW_BOARD_SEQ.NEXTVAL, 'best1234', 1, 
		'애니메이트에 대해 아무것도 몰랐지만 선생님 덕분에 수업을 배운뒤 움직이는 이모티콘 24종을 만들어보기도 했습니다.
		 초보자가 이해하기 쉽도록 활용법을 알려주셔서 처음해보는 저로써는 너무 도움이 되었고 고마운 강의였어요. 언젠가 중급자 수업이 나온다면 또 듣고 싶습니다. 애니메이트를 기반으로 공부하고 싶으신분들께 정말정말 추천드리고 싶어요. 수업 듣는동안 지루하지 않게 해주시고 전 정말 재밋었어요^^!',
		5, SYSDATE);
	
INSERT INTO REVIEW_BOARD
VALUES(REVIEW_BOARD_SEQ.NEXTVAL, 'best1234', 3, 
		'실무에서 겪은 경험을 토대로 평소에 궁금했던 부분이나 조심해야 할 부분, 생각해야 할 부분 등 초보자에게 굉장히 도움이 되는 강의입니다.',
		5, SYSDATE);
INSERT INTO REVIEW_BOARD
VALUES(REVIEW_BOARD_SEQ.NEXTVAL, 'best1234', 3, 
		'아 갑자기 너무 초보자들 챙기는 강의아냐? 하고 봤는데 진짜 너무 좋은데요..
		이 컨텐츠를 이렇게 살릴 수가 있나싶을정도로 소스코드 주는 것도 말도 안되고
		인디로 경직되어버린 제 코드를 개조시켜줄 수 있는 느낌이어서 좋아요~
		그래도 구조에 대해서 조금 더 설명해주셨으면 좋긴 하겠지만요 그러면 유니티 강의를 들어야할까 모르겟네요
		아무튼 감사해요~~',
		5, SYSDATE);
INSERT INTO REVIEW_BOARD
VALUES(REVIEW_BOARD_SEQ.NEXTVAL, 'best1234', 3, 
		'오랜만에 컴백하신 루키스님의 생생한 목소리를 듣게 되어 반갑습니다.
		저는 루키스님의 강의를 다시 학습하고 있는 중에
		때마침 실전 프로젝트 강의를 내주셔서 학습에 많은 인사이트를 얻고 갑니다.
		코드 분석에는 쉽지 않겠지만 mmorpg에서 배운 설계 구조와 비슷하여 차근차근 뜯어 보겠습니다.',
		5, SYSDATE);
INSERT INTO REVIEW_BOARD
VALUES(REVIEW_BOARD_SEQ.NEXTVAL, 'best1234', 3, 
		'강의 들으면서 빈 프로젝트에서 처음부터 만들고 있습니다. 유니티 엔진 강의 들었던게 오래되어서 가물가물 했었는데 복습하면서 그 때 배웠던 내용들이 새록새록 떠올라서 좋았습니다.
		그리고 회사에 가지 않고서는 알기 어려운 팁들은 덤이구요.
		개인적으로 강의를 주구장창 듣는것보다 혼자서 고민하면서 공부하는걸 선호하는데 풀소스코드가 정말 도움이 많이 되는 것 같습니다.',
		5, SYSDATE);
		
--QA_BOARD table에 data 추가
INSERT INTO QA_BOARD VALUES(QA_BOARD_SEQ.NEXTVAL, 'best1234', 1, '다른 클래스와 차이', 
							'클래스 101 애니메이트 강의와 혹시 어떤 차이가 있을까요? 
							애니메이트 처음인데 인프런 강의를 먼저 들어봐도 괜찮을까요?'
							, SYSDATE);
INSERT INTO QA_BOARD VALUES(QA_BOARD_SEQ.NEXTVAL, 'best1234', 1, 'OGQ 콜라보', 
							'OGQ 콜라보는 오늘까지만 하시는 걸까요? ㅠㅠ 
							아직 결제가 불가능한데 너무 아쉬워요!'
							, SYSDATE);
INSERT INTO QA_BOARD VALUES(QA_BOARD_SEQ.NEXTVAL, 'best1234', 1, '어도비 애니메이트', 
							'안녕하세요? 어도비 애니메이트를 구입하려고 하는데요.
							구매창으로 들어가니 Animate , Audition , After Effects, Premiere Rush, Premiere Pro 여러가지가 있는데 여기서 무엇을 구입하면 되나요?!'
							,SYSDATE);
INSERT INTO QA_BOARD VALUES(QA_BOARD_SEQ.NEXTVAL, 'best1234', 1, '그림실력', 
							'안녕하세요  그림을  못  그려도 따라갈 수 있을까요???'
							, SYSDATE);
						
INSERT INTO QA_BOARD 
VALUES(QA_BOARD_SEQ.NEXTVAL, 'best1234', 3, '블로그에 코드 올리기', 
		'소스 코드 분석 내용을 블로그에 올려도 되나요?
		분석 내용을 올리면서 코드 조각을 올릴 생각입니다.'
		, SYSDATE); 
INSERT INTO QA_BOARD 
VALUES(QA_BOARD_SEQ.NEXTVAL, 'best1234', 3, '선수과목', 
		'선수 과목인 Part3 강의를 시청하지 않은 상태면 
		아예 이 강의를 못 따라 가는 수준인가요?'
		, SYSDATE);
INSERT INTO QA_BOARD 
VALUES(QA_BOARD_SEQ.NEXTVAL, 'best1234', 3, '강의 업데이트', 
		'OT영상 듣다가 궁금한점이 생겨서 문의드립니다.!
		단발성이아니라 계속 업데이트 해주신다고하셨는데 
		이강의에서 업데이트 해주시는것인지 다른 강의로 업데이트해주시는지 궁금합니다'
		, SYSDATE);
		
--QA_ANSWER table 및 시퀀스 삭제
DROP TABLE QA_ANSWER CASCADE CONSTRAINTS;
DROP SEQUENCE QA_ANSWER_SEQ;
...
--QA_ANSWER table에 data 추가
INSERT INTO QA_ANSWER VALUES(1, 'best1234', 2, 
							'안녕하세요 그리네모입니다.
							인프런은 애니메이트로 이모티콘 제작에 중점을 둔 강의에요.
							그래서 캐릭터 애니메이션 만들기와 이모티콘 제작 노하우 비중이 큽니다.
							물론 애니메이트의 기초도 배울 수 있도록 커리큘럼을 짰기 때문에 입문 및 초급자도 수강할 수 있습니다.', 
							SYSDATE);
INSERT INTO QA_ANSWER VALUES(1, 'best1234', 3, 
							'네, 어제 날짜까지 이벤트 기간이었어요. 인프런하고 오지큐간의 협업이라 제가 어찌 해드릴 수 없네요 😭', 
							SYSDATE);
INSERT INTO QA_ANSWER VALUES(1, 'best1234', 4, 
							'안녕하세요.
							Animate 를 구입하면 되구요, 수업이 한글판으로 진행되기 때문에 한글판을 설치해야 합니다.
							앱 플랜과 결제에 관한 자세한 사항은 고객센터에 문의 후 구입 및 설치를 진행하는 것이 좋습니다.
							
							참고로 한글판과 영문판은 동시에 설치할 수 없습니다.
							
							감사합니다!', 
							SYSDATE);
INSERT INTO QA_ANSWER VALUES(1, 'best1234', 5, 
							'안녕하세요. 그리네모입니다.
							애니메이트와 이모티콘에 대해 배우는 것이 목적이기 때문에 그림을 잘 그리지 못해도 괜찮습니다.
							예제 역시 밑그림 파일을 제공하기 때문에 대강 그려도 되고요.
							
							참고로 애니메이트의 기초적인 것들을 배우고 싶다면 
							제 수업을 굳이 결제하지 않아도 어도비 홈페이지나 인앱 튜토리얼만으로 충분할 거에요.', 
							SYSDATE);
INSERT INTO QA_ANSWER 
VALUES(3, 'best1234', 6, 
		'부분적으로 올리는 것은 괜찮습니다. 감사합니다!', 
		SYSDATE);
INSERT INTO QA_ANSWER 
VALUES(3, 'best1234', 7, 
		'어차피 스스로 분석하는 강의라 못 따라 가는 수준까진 아니겠지만,
		일반 서적과는 다루게 구현하는 부분이 있어 헷갈릴 수 있습니다.', 
		SYSDATE);
INSERT INTO QA_ANSWER 
VALUES(3, 'best1234', 8, 
		'다른 프로젝트로 올릴 예정이고,
		이번 프로젝트 내에서도 많은 분들이 공통적으로 궁금해하는 부분이 있다면
		추가 영상을 올릴 예정입니다.', 
		SYSDATE);
		
--22.09.23 변경
ALTER TABLE CURRICULUM_BIG RENAME COLUMN CUR_BIG_CURID TO CUR_BIG_CHAPID;
ALTER TABLE CURRICULUM_SMALL RENAME COLUMN CUR_SMALL_CURID TO CUR_SMALL_CHAPID;
ALTER TABLE CURRICULUM_SMALL ADD CUR_SMALL_CURID NUMBER;
