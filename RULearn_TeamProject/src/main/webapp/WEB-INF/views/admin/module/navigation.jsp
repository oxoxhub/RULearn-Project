...
<nav class="py-2">
   	<div class="container d-flex flex-wrap justify-content-end">
   		...
   		<c:if test="${not empty sessionScope.loginData}">
   			<li class="nav-item"><a href="${mainUrl}admin/memberInfo" class="ru_top_nav_link px-2">관리자페이지</a></li>
	...
	<div class="container d-flex flex-wrap">
		...
		<form action="${mainUrl}allsearch" method="get" class="col-12 col-lg-auto mb-lg-0 mt-1">
			<div class="input-group">
				<input class="form-control search_background" type="text" id="allSearch" name="allSearch" placeholder="search">
			</div>
		</form>
	</div>
</div>