...
<body class="text-center">
	<main class="form-signin w-100 m-auto">
		...
		<ul class="nav login_nav_tabs mt-4" role="tablist">
			<li class="nav-item">
				<a class="find_nav_link active" href="${mainUrl}login/find_id">아이디찾기</a>
				</li>
			<li class="nav-item">
				<a class="find_nav_link" href="${mainUrl}login/find_pw">비밀번호찾기</a>
			</li>
		</ul>
		<div class="login_card text-start">
			<div class="tab-content card-body">
					<c:url var="loginUrl" value="/login" />
					<form action="${loginUrl}/find_id" method="post">
						...
						<button class="w-100 login_btn btn-lg btn-primary p-3 mt-4" type="submit">아이디찾기</button>
					</form>
			</div>
		</div>
