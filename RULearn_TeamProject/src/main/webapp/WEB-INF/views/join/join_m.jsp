			...
			<div class="tab-content card-body">
				...
				<form action="${joinUrl}" method="post" name="joinForm">
					<div class="form-group">
						...
						<input class="form-control p-2" type="text" id="id" name="id" oninput="checkId();" value="${param.id}">
					...
					<div class="form-group">
						...
						<input class="form-control p-2" type="text"  id="nickname" name="nickname" oninput="checkNickname();" value="${param.nickname}">
						<span class="chk_message"></span>
					</div>
					<div class="form-group">
						<label class="col-form-label mt-3" for="name">이름</label>
						<input class="form-control p-2" type="text"  id="name" name="name" value="${param.name}">
						<span class="chk_message"></span>
					</div>
					<div class="form-group">
						<label class="col-form-label mt-3" for="phone">핸드폰번호</label>
						<input class="form-control p-2" type="text"  id="phone" name="phone" oninput="checkPhone();" value="${param.phone}">
						<span class="chk_message"></span>
					</div>
					<div class="form-group">
						<label class="col-form-label mt-3" for="email">본인 확인 이메일</label>
						<input class="form-control p-2" type="email" id="email" name="email" oninput="checkEmail();" value="${param.email}">
						<span class="chk_message"></span>
					</div>
