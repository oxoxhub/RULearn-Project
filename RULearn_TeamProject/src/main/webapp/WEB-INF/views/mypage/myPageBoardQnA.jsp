		...
		<div class="row">
			...
			<div class="col_md_9 ms-3">
				...
				<div id="myTabContent" class="tab-content">
					<br>
					<c:if test="${not empty qaBoardList}">
						<c:forEach items="${qaBoardList}" var="qaBoard">
							...
							<c:set var="origin_title" value="${qaBoard.cb_title}" />
							...
							<div class="tab-pane active show" id="QAndA" role="tabpanel"
								...
								<ul class="list-group">
									<li
										...
										<span class="badge bg-primary col-1"> Q&A </span>
										<div class="inner col-5">${diff_title}</div>
										<div class="col-3">${qaBoard.cb_wid}</div>
										<div class="col-2">${qaBoard.cb_date}</div>
										<div class="col-1">♥${qaBoard.cb_like}</div>
									</li>
								</ul>
							</div>
						</c:forEach>
