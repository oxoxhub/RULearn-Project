	...
	<div class="container m-height">
		<div class="row">
			<div class="col-md-3">
				 ...
				 <div class="d-flex flex-column flex-shrink-0 p-3 bg-light">
					 <ul class="nav nav_pills mb-auto px-3 bg-light d-flex flex-column">
	                    ...
	                    <li>
	                        <a href="${mypageURL}/wishlist/${sessionScope.loginData.AC_ID}" class="nav-link">
	                            수강바구니
	                        </a>
	                    </li>
	                    <li>
			...
			<div class="col_md_9 ms-3">
				...
				<!-- 결제 후 -->
				<c:choose>
					<c:when test="${result eq 'DONE'}">
						<section class="text-center">
							<div>
								<i class="bi bi-cart-check-fill text-danger fs-1"></i>
							</div>
							<br>
							<h4 class="mt-2 mb-1"><mark>${orderName}</mark> </h4>
							<br>
							<h4>강의가 결제되었습니다. <br>
					...
					<c:when test="${result eq 'CANCELED'}">
						<section class="text-center">
